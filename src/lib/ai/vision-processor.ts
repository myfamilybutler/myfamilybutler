/**
 * Internal Vision Processor
 *
 * Extracts calendar events from images using AI vision models.
 * This is a regular server-side module (not a Server Action) so it can be
 * called safely from the messaging pipeline without crossing the action boundary.
 */
...
export async function processVisionMessageInternal(
