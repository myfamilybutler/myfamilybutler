...
export default async function WhoAmIPage() {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-8">
      <h1 className="text-2xl font-bold">Admin Debugger (Who Am I?)</h1>
      ...
      <div className="rounded border border-blue-200 bg-blue-100/60 p-4 dark:border-blue-500/30 dark:bg-blue-500/15">
