      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 sm:p-12">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Datenweitergabe und Drittanbieter</h2>
            ...
            {/* Section 9 */}
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Beschwerderecht</h2>
              <p>
            ...
            {/* Section 10 */}
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Änderungen der Datenschutzerklärung</h2>
              <p>
