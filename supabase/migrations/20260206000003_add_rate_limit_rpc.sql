-- Migration: Add atomic rate limiting RPC in canonical migration path
...
COMMENT ON FUNCTION public.check_rate_limit IS 'Atomic rate limiting function that prevents race conditions';
